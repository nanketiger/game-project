...
const RELICS = [
    ...
    },
    {
        ...
        icon: 'images/遗物图标/2生命水晶.png',
        story: '深红色水晶内部流淌着柔和的光芒，据说是远古生命之树凝结的精华。它能将生命能量直接注入持有者体内，修复受损的躯壳，让疲惫的身体重新焕发活力。',
        apply: function () { maxHealth += 20; playerHealth = maxHealth; }
    },
    {
        id: 3,
        name: '吸血芯片',
    ...
    },
    {
        ...
        apply: function () { /* 效果在 shoot 时触发，检查 selectedRelics.includes(7) */ }
    },
    {
        id: 8,
        name: '冰霜核心',
    ...
    },
    {
        ...
        apply: function () { /* 效果在 refreshMap 时触发，检查 selectedRelics.includes(12) */ }
    },
    {
        id: 13,
        name: '瞄准镜',
...
function showRelicSelection() {
    ...
    if (rerollDiv && selectedRelics.includes(14)) {
